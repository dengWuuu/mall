...
import com.wu.common.utils.HttpUtils;
import com.wu.mall.dao.MemberLevelDao;
...
import com.wu.mall.dao.MemberDao;
...
public class MemberServiceImpl extends ServiceImpl<MemberDao, MemberEntity> implements MemberService {
    ...
    public void checkPhoneUnique(String phone) throws PhoneExsitException {
        MemberDao memberDao = this.baseMapper;
        int mobile = Math.toIntExact(memberDao.selectCount(new QueryWrapper<MemberEntity>().eq("mobile", phone)));
        if (mobile > 0) {
    ...
    public void checkUsernameUnique(String username) throws UsernameExistException {
        MemberDao memberDao = this.baseMapper;
        int count = Math.toIntExact(memberDao.selectCount(new QueryWrapper<MemberEntity>().eq("username", username)));
        if (count > 0) {
